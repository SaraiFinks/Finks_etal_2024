...
#Response to reviewer's comments - revised Figure 1C.
...
figure_1c <-
  ggplot(his_sizes,
         aes(
           x = log10_plasmid_length,
           y = fct_relevel(Ecotype,
                           "Other",
                           "I",
                           "II",
                           "III",
                           "V"),
           fill = fct_relevel(Ecotype,
                              "Other",
                              "I",
                              "II",
                              "III",
  ...
  scale_x_continuous(breaks = seq(0, 6, by = 0.25), expand = c(0, 0)) +
